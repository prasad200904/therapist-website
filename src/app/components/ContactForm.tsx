    ...
    <section id="contact" className="bg-[#F5F5F5] py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-8 space-y-6">
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-1">What brings you here? *</label>
            <textarea
              name="message"
              value={form.message}
              onChange={handleChange}
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-1">Preferred time to reach you *</label>
            <input
              type="text"
              name="time"
              value={form.time}
